  ...
  return (
    <main className="relative flex min-h-screen overflow-hidden bg-[var(--color-bg)] px-4 py-8 sm:px-6 sm:py-12">
      ...
      <div className="relative mx-auto flex w-full max-w-2xl flex-col">
        <header className="mb-8 flex items-start justify-between gap-4 px-1 sm:mb-10">
          <div>
        ...
        <section aria-label="Quick access">
          <h2 className="mb-3 px-1 text-xs font-semibold uppercase tracking-[0.18em] text-[var(--color-text-dim)]">
            Quick access
          </h2>
